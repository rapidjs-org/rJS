...
class GetEntity extends Entity_1.Entity {
    ...
    localPath() {
        ...
        return decodeURIComponent((0, path_1.join)(config_server_1.default.directory.web, this.url.pathname));
    }
    /**
    ...
    respond(status, message) {
        ...
        const mime = config_server_1.default.mimes[this.extension];
        if (mime) {
        ...
        if (message
            ...
            // Compress
            message = (0, zlib_1.gzipSync)(message);
        }
