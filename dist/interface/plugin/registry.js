...
exports.initClientModule = exports.retrieveClientModules = exports.isClientModuleRequest = exports.integratePluginReferences = exports.bind = void 0;
const config = {
...
const detection_1 = require("../../live/detection");
...
bindings_1.pluginRegistry.set("core", {
    path: null,
    environment: Environment_1.Environment.ANY,
    clientScript: (0, fs_1.readFileSync)((0, path_1.join)(__dirname, "../../client/core.js")),
});
/**
...
function bind(reference, options = {}) {
    ...
    const pluginPath = pluginNameRegex.test(reference)
        ? module.constructor._resolveFilename(reference, require.main)
        : (0, normalize_1.truncateModuleExtension)((0, path_1.join)((0, path_1.dirname)(require.main.filename), reference));
    ...
    // Register 
    (0, detection_1.registerDetectionDir)(pluginPath);
}
exports.bind = bind;
/**
...
function isClientModuleRequest(pathname) {
    if (!(new RegExp(`^${urlPrefixRegex.source}${config.pluginNameRegex.source}(\\${config.pluginNameSeparator}${config.pluginNameRegex.source})*`, "i"))
        .test(pathname)) {
        return false;
    }
    return true;
 ...
 */
function initClientModule(relativePath, pluginConfig, compoundOnly) {
